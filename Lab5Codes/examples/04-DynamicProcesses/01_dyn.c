 ...
 *
 * Run: 01_dyn [number_of_processes]
 *      If UNIVERSE_SIZE is supported, this program runs as many children as possible.
 *      Other wise, number_of_processes will be used.
 * 
...
int main(int argc, char *argv[])
{
   ...
   {
     printf("Universe size is %d. This will spawn %d workers\n",
